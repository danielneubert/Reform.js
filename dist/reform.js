...
(function (factory) {
   ...
   */
  function Reform(parentSelector, settings) {
    _classCallCheck(this, Reform);
  ...
  Reform.prototype.ensureParam = function (argument, argumentType, defaultValue) {
    return (typeof argument === 'undefined' ? 'undefined' : _typeof(argument)) !== argumentType ? defaultValue : argument;
  };
  ...
  Reform.prototype.getLabel = function (key) {
    ...
    if (_typeof(this.options.localization[this.options.lang]) === 'object') {
  ...
  Reform.prototype.validateString = function (element, value, validationType) {
    ...
    switch (validationType) {
      ...
      case 'url':
        {
          var regEx = /^(http(s?)\:\/\/|~\/|\/)?([a-zA-Z]{1}([\w\-]+\.)+([\w]{2,7}))(:[\d]{1,5})?\/?(\w+\.[\w]{3,4})?((\?\w+=\w+)?(&\w+=\w+)*)?/;
      ...
      case 'phone':
        {
          var _regEx2 = /^(((((((00|\+)[0-9][0-9]{1,2}[ \-/]?)|0)[1-9][0-9]{1,4})[ \-/]?)|((((00|\+)49\()|\(0)[1-9][0-9]{1,4}\)[ \-/]?))[0-9]{1,7}([ \-/]?[0-9]{1,5})?)$/;
  ...
  Reform.prototype.init = function () {
    ...
    var parentToString = this.$parent.prop('outerHTML').split('>', 1)[0] + '>';
  ...
  Reform.prototype.validate = function () {
    ...
    if ($('.rf-group', _.parent).length) {
      $('.rf-group', _.parent).each(function () {
        ...
        var groupChildCounter = $('label', this).length;
                ...
                if ($('input, textarea', this).val().length < _.options.validation.minLength) {
                  ...
                  if ($(this).hasClass('rf-val')) {
                    ...
                    if (!_.validateString($(this), $('input', this).val(), validationType)) {
                      ...
                      _.outputError(this, _.getLabel('errorValidation' + validationType.charAt(0).toUpperCase() + validationType.slice(1).toLowerCase()));
                    }
                  }
                }
                break;
  ...
  Reform.prototype.sendForm = function () {
    ...
    // destination url
    var formUrl = this.ensureParam(_.$parent.attr('rf-url'), 'string', undefined);
    ...
    // sending method
    var formType = this.ensureParam(_.$parent.attr('rf-type'), 'string', undefined);
  ...
  Reform.prototype.groupBehavior = function () {
    ...
    $('.rf-group.rf-group-single', this.parent).each(function () {
      $('input', this).change(function () {
        ...
        var inputIsChecked = $(this).is(':checked');
  ...
  $.fn.reform = function () {
    ...
    for (var i = 0; i < this.length; i++) {
      if ((typeof settings === 'undefined' ? 'undefined' : _typeof(settings)) === 'object' || typeof settings === 'undefined') {
